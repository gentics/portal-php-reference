...
<section class="item-details text-left">
    ...
    <div class="starReviews col-xl-4 col-lg-3 col-sm-8 row d-none">
        <div class="review-left col-lg-6 col-sm-12">
            <div class="progress">
                <div class="progress-bar text-left pl-2" role="progressbar" style="width: 90%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                    title="50%">5 star</div>
            </div>
            <div class="progress">
                <div class="progress-bar text-left pl-2" role="progressbar" style="width: 30%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                    title="50%">4 star</div>
            </div>
            <div class="progress">
                <div class="progress-bar text-left pl-2" role="progressbar" style="width: 50%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                    title="50%">3 star</div>
            </div>
            <div class="progress">
                <div class="progress-bar text-left pl-2" role="progressbar" style="width: 25%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                    title="50%">2 star</div>
            </div>
            <div class="progress">
                <div class="progress-bar text-left pl-2" role="progressbar" style="width: 20%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                    title="50%">1 star</div>
            </div>
        </div>
